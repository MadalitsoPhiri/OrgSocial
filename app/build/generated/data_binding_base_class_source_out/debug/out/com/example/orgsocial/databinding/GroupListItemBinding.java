...
public final class GroupListItemBinding implements ViewBinding {
  ...
  private GroupListItemBinding(@NonNull LinearLayout rootView, @NonNull ImageButton checked,
  ...
  public static GroupListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new GroupListItemBinding((LinearLayout) rootView, checked, profileImage,
