...
public final class ContactListItemBinding implements ViewBinding {
  ...
  private ContactListItemBinding(@NonNull LinearLayout rootView, @NonNull ImageButton checked,
  ...
  public static ContactListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContactListItemBinding((LinearLayout) rootView, checked, description, profileImage,
