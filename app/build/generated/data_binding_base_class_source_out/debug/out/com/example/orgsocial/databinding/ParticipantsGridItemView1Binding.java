...
public final class ParticipantsGridItemView1Binding implements ViewBinding {
  @NonNull
  ...
  private ParticipantsGridItemView1Binding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ParticipantsGridItemView1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ParticipantsGridItemView1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.participants_grid_item_view1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ParticipantsGridItemView1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ParticipantsGridItemView1Binding((LinearLayout) rootView, profileImage,
