...
public class AdminAddedAdapter extends RecyclerView.Adapter<AdminAddedAdapter.ViewHolder> {
     List<GroupUser> list;
    ...
    public AdminAddedAdapter(List<GroupUser> list, Context context, RecyclerView recyclerView, List<GroupUser> superuser) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
              final GroupUser currentUser = list.get(position);
 ...
 ProgressBar progress;
    ...
    public  void unCheck(GroupUser current){

       int position = list1.indexOf(current);
        AdminAdapter.Holder currentHolder = (AdminAdapter.Holder) recycler.findViewHolderForAdapterPosition(position);
